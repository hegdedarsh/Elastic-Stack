...
7)Now login to the data nodes and go to the tmp directory and then change the ownership to elastic user.Once done move the file to config folder in elasticsearch. Do it for botht the nodes
